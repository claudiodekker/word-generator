...
You can control how many adjectives are used to generate the string, up to 10:
...
echo Generator::generate('-', 2); // Outputs 'autumn-billowing-firefly', 'crimson-patient-meadow', etc.
```
